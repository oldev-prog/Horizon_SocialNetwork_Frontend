    ...
    <div className="profile_content">
      <div className="post_container">
          ...
          <div className="post_content_container" onClick={handleClickPost}>
              <p className="post_text">Occupy Mars!
                  ...
                  This would act as a "deflector shield," allowing the planet to regain its atmospheric pressure naturally over time.</p>
              <img className="post_media"
                   src="../public/Mars.png"
              />
          </div>
        ...
        <div className="post_container">
            <div className="author_container">
                <img className="author_avatar" src='../public/myphoto.jpg'/>
                <p className="author_name">Oleg Zolotarev</p>
                <p className="publication_time">1 Jun</p>
            </div>
            <div className="post_content_container">
                <p className="post_text">Happy New Year!</p>
        ...
        <div className="post_container">
            <div className="author_container">
                <img className="author_avatar" src='../public/myphoto.jpg'/>
                <p className="author_name">Oleg Zolotarev</p>
                <p className="publication_time">15 Dec</p>
            </div>
            <div className="post_content_container">
                <p className="post_text">God bless America</p>
            </div>                    strokeLinejoin="round"
            <div className="post_interactions">
                <div className="like_container">
                    <button
